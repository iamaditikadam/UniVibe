// Script to seed events with dates in 2026 (future dates)
...
const sampleEvents = [
  ...
  },
  {
    ...
    time: '2:00 PM',
    endDate: new Date('2026-02-18T17:00:00'),
    endTime: '5:00 PM',
  ...
  },
  {
    ...
    time: '9:00 AM',
    endDate: new Date('2026-02-27T17:00:00'),
    endTime: '5:00 PM',
  ...
  },
  {
    ...
    category: 'Wellness',
    date: new Date('2026-02-22T08:00:00'),
    time: '8:00 AM',
    endDate: new Date('2026-02-22T12:00:00'),
    endTime: '12:00 PM',
...
async function clearAndSeedFutureEvents() {
  try {
    ...
    console.log(`✅ Deleted ${snapshot.docs.length} existing events`);
    
    console.log('🌱 Seeding new events with 2026 dates...');
    ...
    console.log('🎉 Successfully cleared and re-seeded all events with 2026 dates!');
    process.exit(0);
  } catch (error) {
